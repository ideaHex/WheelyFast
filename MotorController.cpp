...
motorController::motorController(uint8_t motorA_pin , uint8_t PWM_A_pin,uint8_t motorB_pin , uint8_t PWM_B_pin)
{
...
//motorController::motorController(uint8_t motorA_pin , uint8_t motorA_pin_2 ,uint8_t motorB_pin , uint8_t motorB_pin_2){
//  analogWriteFreq(PWMFrequency); //Theoretical max frequency is 80000000/range, range = 1024 so 78Khz here
//  mPA1 = motorA_pin;
//  mPA2 = motorA_pin_2;
//  mPB1 = motorB_pin;
